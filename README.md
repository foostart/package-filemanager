...
Route::group(['middleware' => 'auth'], function () {
    Route::get('/laravel-filemanager', '\Foostart\Filemanager\controllers\LfmController@show');
    Route::post('/laravel-filemanager/upload', '\Foostart\Filemanager\controllers\UploadController@upload');
